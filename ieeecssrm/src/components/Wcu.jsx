    ...
    <div className="bg-black flex items-center justify-center p-6 py-36">
      ...
      <div className="flex flex-col lg:flex-row w-full max-w-5xl space-y-6 lg:space-y-0 lg:space-x-6">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center text-center lg:text-left">
          ...
          <button className="max-w-[130px] mt-6 mx-auto lg:mx-0 w-[50%] lg:w-[25%] text-[#FFA800] border border-[#FFA800] px-3 py-2 rounded-3xl font-agrandir font-semibold text-[12px]">
            LET'S CONNECT
          </button>
        </div>
      </div>
